...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ error: 'Error al leer el archivo1 '})
    }
})
...
router.get('/:pid', async (req, res) => {
    ...
    try {
        ...
        console.log('Error al leer el archivo', error)
        res.status(500).json({ error: 'Error al leer el archivo2'})
    }
})
...
router.delete('/:pid', async(req, res) => {
    ...
    try {
        ...
        if (productIndex != -1) {
            ...
            await async.promises.writeFile(filePathProducts, JSON.stringify(products, null,2))
